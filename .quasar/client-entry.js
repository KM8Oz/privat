...
import qboot_Boottouchs from 'boot/touchs'
...
import qboot_Bootplayer from 'boot/player'

import qboot_Bootnotification from 'boot/notification'

import qboot_Bootclipboard from 'boot/clipboard'

import qboot_Bootuploaderv2 from 'boot/uploaderv2'

import qboot_Bootcropper from 'boot/cropper'

import qboot_Bootcomponents from 'boot/components'

import qboot_Bootuploader from 'boot/uploader'
